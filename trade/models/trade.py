...
class Trade(BaseModel):
    ...
    symbol = models.CharField(
        max_length=10, choices=SYMBOL_CHOICES, null=True, blank=True
    )
    amount = models.DecimalField(max_digits=12, decimal_places=2)
    status = models.CharField(
        max_length=100, null=True, blank=True, choices=STATUS, default="open"
    )
    ...
    allow_close_trade = models.BooleanField(default=False)
